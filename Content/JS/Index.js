...
var webVerElement = document.getElementsByClassName('WebVerElement');
...
side_bar.innerHTML += `
	...
	<a href='./EquipmentData.html' class="side-button" id="equipment-btn">Equipment List <span class="icon icon-equipment"></a>
	...
	<a href='./MiscData.html' class="side-button" id="Misc-btn">Misc  <span style="background-repeat: no-repeat;" class="icon icon-misc"></span></a>
`
}
if (nav_tab){
nav_tab.innerHTML += `
...
function changeTheme(wallpaper){
	...
	if(wallpaper_change){wallpaper_change.value = wallpaper; banner_container.style.backgroundImage = `url("./Content/Graphics/Wallpapers/${wallpaper}.png")`}
...
if (localStorage_Wallpaper){
	...
	if(wallpaper_change){wallpaper_change.value = localStorage_Wallpaper}
}
else{
