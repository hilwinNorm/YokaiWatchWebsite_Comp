...
function showPage(yokais) {
	...
	for (const [key,yokai] of Object.entries(yokais)) {
		...
		if (legalCheck(yokai)){
			...
			var YokaiInspiritImage = GenericInspiritIDs[inspiritDatabase[yokai.InspiritID].GenericEffectID]+'.png'
			Img_InspiritType.src = "Content/Graphics/InspiritImages/"+YokaiInspiritImage
			Img_InspiritType.alt="YokaiInspiritImg"
			
			var YokaiInspirit = inspiritDatabase[yokai.InspiritID].GenericEffectID
