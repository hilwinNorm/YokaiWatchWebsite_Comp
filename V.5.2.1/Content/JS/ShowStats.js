...
function showYokaiDetails(Yokai_Data) {
    ...
    const details = `
        ...
        <p id="yokai-max-hp" style="font-size: 20px"><u>HP: ${Math.round(BHP)}</u></p>
        <p id="yokai-strength" style="font-size: 20px"><u>STR: ${Math.round(BSTR)}</u></p>
        <p id="yokai-spirit" style="font-size: 20px"><u>SPR: ${Math.round(BSPR)}</u></p>
        <p id="yokai-defense" style="font-size: 20px"><u>DEF: ${Math.round(BDEF)}</u></p>
        <p id="yokai-speed" style="font-size: 20px"><u>SPD: ${Math.round(BSPD)}</u></p>
        ...
        <p>Technique: ${technique.Command} | Technique Element: ${technique.Element} <img style="height:20px; width: auto;"src="Content/Graphics/Elements/${technique.Element}.png" alt="ElementImg"> | Technique Power: ${technique.Lv10_power} | Technique Probability: ${yokai.techniqueProb}</p>
	...
	for (i = 0; i < Attitudes.length; i++){
		...
		document.getElementById('yokai-max-hp').textContent = `Max HP: ${Math.round(BHP) + Attitudes[Attitude.value].boost[0]}`;
        document.getElementById('yokai-strength').textContent = `STR: ${Math.round(BSTR) + Attitudes[Attitude.value].boost[1]}`;
        document.getElementById('yokai-spirit').textContent = `SPR: ${Math.round(BSPR) + Attitudes[Attitude.value].boost[2]}`;
        document.getElementById('yokai-defense').textContent = `DEF: ${Math.round(BDEF) + Attitudes[Attitude.value].boost[3]}`;
        document.getElementById('yokai-speed').textContent = `SPD: ${Math.round(BSPD) + Attitudes[Attitude.value].boost[4]}`;
	})
